            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    <div class="categories__text">
                        <h1>L'Art Africain dans toute sa Splendeur</h1>
                        <p>Explorez les œuvres uniques d'artisans talentueux, et 
                        connectez-vous avec eux pour donner vie à votre passion pour l'art.</p>
                        <a href="{{ route('explorez') }}">Explorez maintenant</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="{{asset('assets/img/categories/category-2.jpg')}}">
                            <div class="categories__text">
                                <h4>Masques</h4>
                                <a href="{{ route('explorez') }}">Explorez</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="{{asset('assets/img/categories/category-3.jpg')}}">
                            <div class="categories__text">
                                <h4>Textiles et <br>Tapisseries</h4>
                                <a href="{{ route('explorez') }}">Explorez</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="{{asset('assets/img/categories/category-5.jpg')}}">
                            <div class="categories__text">
                                <h4>Paniers <br>tressés et <br> vannerie</h4>
                                <a href="{{ route('explorez') }}">Explorez</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="section-title">
                    <h4>Nouvelles Oeuvres</h4>
                </div>
            </div>
            <div class="col-lg-8 col-md-8">
                <ul class="filter__controls">
                    <li class="active" data-filter="*">Tous</li>
                    <li data-filter=".women">Masques</li>
                    <li data-filter=".men">Textiles et <br>Tapisseries</li>
                    <li data-filter=".kid">Tableaux</li>
                    <li data-filter=".accessories">Sculptures</li>
                    <li data-filter=".cosmetic">Paniers
tressés et
vannerie</li>
                </ul>
            </div>
